...
NextSchedule _$NextScheduleFromJson(Map<String, dynamic> json) {
  return _NextSchedule.fromJson(json);
}

/// @nodoc
mixin _$NextSchedule {
  ...
  @JsonKey(ignore: true)
  $NextScheduleCopyWith<NextSchedule> get copyWith =>
      throw _privateConstructorUsedError;
}

/// @nodoc
abstract class $NextScheduleCopyWith<$Res> {
  factory $NextScheduleCopyWith(
          NextSchedule value, $Res Function(NextSchedule) then) =
      _$NextScheduleCopyWithImpl<$Res, NextSchedule>;
  @useResult
  $Res call(
...
/// @nodoc
class _$NextScheduleCopyWithImpl<$Res, $Val extends NextSchedule>
    implements $NextScheduleCopyWith<$Res> {
  _$NextScheduleCopyWithImpl(this._value, this._then);
...
/// @nodoc
abstract class _$$_NextScheduleCopyWith<$Res>
    implements $NextScheduleCopyWith<$Res> {
  factory _$$_NextScheduleCopyWith(
          _$_NextSchedule value, $Res Function(_$_NextSchedule) then) =
      __$$_NextScheduleCopyWithImpl<$Res>;
  @override
  @useResult
  $Res call(
      {int? createdAtTimeStamp,
...
/// @nodoc
class __$$_NextScheduleCopyWithImpl<$Res>
    extends _$NextScheduleCopyWithImpl<$Res, _$_NextSchedule>
    implements _$$_NextScheduleCopyWith<$Res> {
  __$$_NextScheduleCopyWithImpl(
      _$_NextSchedule _value, $Res Function(_$_NextSchedule) _then)
      : super(_value, _then);
...
/// @nodoc
@JsonSerializable()
class _$_NextSchedule implements _NextSchedule {
  const _$_NextSchedule(
  ...
  factory _$_NextSchedule.fromJson(Map<String, dynamic> json) =>
      _$$_NextScheduleFromJson(json);
  ...
  @override
  @pragma('vm:prefer-inline')
  _$$_NextScheduleCopyWith<_$_NextSchedule> get copyWith =>
      __$$_NextScheduleCopyWithImpl<_$_NextSchedule>(this, _$identity);

  @override
  Map<String, dynamic> toJson() {
    return _$$_NextScheduleToJson(
      this,
    );
  }
}

abstract class _NextSchedule implements NextSchedule {
  const factory _NextSchedule(
      {final int? createdAtTimeStamp,
      final int? updatedAtTimeStamp,
      final String? id,
      final String? userId,
  ...
  factory _NextSchedule.fromJson(Map<String, dynamic> json) =
      _$_NextSchedule.fromJson;
