...
class CousesPage extends StatefulWidget {
  const CousesPage({Key? key}) : super(key: key);

  @override
  State<CousesPage> createState() => _CousesPageState();
}

class _CousesPageState extends State<CousesPage> with SingleTickerProviderStateMixin{
